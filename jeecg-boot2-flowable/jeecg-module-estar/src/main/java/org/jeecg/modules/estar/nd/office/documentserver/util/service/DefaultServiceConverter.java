...
package org.jeecg.modules.estar.nd.office.documentserver.util.service;
...
import org.jeecg.modules.estar.nd.office.dto.Convert;
...
public class DefaultServiceConverter implements ServiceConverter
{
    ...
    @Value("${nbcio.files.docservice.url.converter}")
    private String docServiceUrlConverter;
    @Value("${nbcio.files.docservice.timeout}")
