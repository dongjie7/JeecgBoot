...
package org.jeecg.modules.estar.nd.office.mappers;
...
import org.jeecg.modules.estar.nd.office.entities.Permission;

import javax.annotation.PostConstruct;

@Component
@Primary
public class PermissionsMapper extends AbstractMapper<Permission, org.jeecg.modules.estar.nd.office.documentserver.models.filemodel.Permission> {
    @Autowired
    private ModelMapper mapper;

    public PermissionsMapper() {
        super(org.jeecg.modules.estar.nd.office.documentserver.models.filemodel.Permission.class);
    }

    @PostConstruct
    public void configure() {  // configure the permission mapper
        mapper.createTypeMap(Permission.class, org.jeecg.modules.estar.nd.office.documentserver.models.filemodel.Permission.class)  // create the type map
                .setPostConverter(modelConverter());  // and apply the post converter to it
    }

    @Override
    void handleSpecificFields(Permission source, org.jeecg.modules.estar.nd.office.documentserver.models.filemodel.Permission destination) {  // handle specific permission fields
