...
import org.jeecg.modules.estar.nd.office.documentserver.managers.template.TemplateManager;
import org.jeecg.modules.estar.nd.office.documentserver.models.enums.Action;
import org.jeecg.modules.estar.nd.office.documentserver.models.enums.Mode;
import org.jeecg.modules.estar.nd.office.documentserver.models.filemodel.EditorConfig;
...
import org.jeecg.modules.estar.nd.office.mappers.Mapper;
import org.jeecg.modules.estar.nd.office.services.configurers.EditorConfigConfigurer;
import org.jeecg.modules.estar.nd.office.services.configurers.wrappers.DefaultCustomizationWrapper;
import org.jeecg.modules.estar.nd.office.services.configurers.wrappers.DefaultEmbeddedWrapper;
...
public class DefaultEditorConfigConfigurer implements EditorConfigConfigurer<DefaultFileWrapper> {
    ...
    @Autowired
    private Mapper<User, org.jeecg.modules.estar.nd.office.documentserver.models.filemodel.User> mapper;
...
//        String fileExt = fileUtility.getFileExtension(fileName);
        ...
        boolean userIsAnon = wrapper.getUser().getRealname().equals("Anonymous");  // check if the user from the editorConfig wrapper is anonymous or not
        ...
        config.setCallbackUrl(documentManager.getCallback(userFile.getId()));  // set the callback URL to the editorConfig
