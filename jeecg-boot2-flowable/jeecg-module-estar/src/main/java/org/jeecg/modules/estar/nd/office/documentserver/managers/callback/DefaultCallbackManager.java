...
package org.jeecg.modules.estar.nd.office.documentserver.managers.callback;


import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import org.jeecg.modules.estar.nd.office.documentserver.managers.document.DocumentManager;
import org.jeecg.modules.estar.nd.office.documentserver.storage.FileStorageMutator;
...
public class DefaultCallbackManager implements CallbackManager {
    ...
    @Value("${nbcio.files.docservice.url.command}")
    private String docserviceUrlCommand;
    @Value("${nbcio.files.docservice.header}")
