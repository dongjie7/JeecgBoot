...
public class SysCustomFormController extends JeecgController<SysCustomForm, ISysCustomFormService> {
	...
	@ApiOperation(value="系统自定义表单表-分页列表查询", notes="系统自定义表单表-分页列表查询",response = SysCustomForm.class)
	...
	public Result<?> queryPageList(SysCustomForm sysCustomForm,
		...
		queryWrapper.like(StringUtils.isNotBlank(sysCustomForm.getBusinessName()),"business_name", sysCustomForm.getBusinessName());
