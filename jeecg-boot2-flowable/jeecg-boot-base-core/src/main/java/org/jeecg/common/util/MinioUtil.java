...
public class MinioUtil {
    ...
    /**
     * 获取MinioClient,为个人网盘提供接口  add by nbacheng
     * @param
     * @param
     * @return
     */
    public static MinioClient getMinioClient() {
        return initMinio(minioUrl, minioName, minioPass);
    }
     ...
     * @return
     */
    public static byte[] downloadFile(String fileObjectName) throws Exception {

        byte[] fileBytes = null;
        InputStream inputStream = null;
        try {
            inputStream = getMinioFile(null, fileObjectName);
            if (inputStream == null) {
                log.info("file not exist in minio store, objectName="+ fileObjectName);
            }
            fileBytes = IOUtils.toByteArray(inputStream);
        } catch (Exception e) {
            log.info("read file from minio store error, objectName="+ fileObjectName);
        } finally {
            if (inputStream != null) {
                try {
                    inputStream.close();
