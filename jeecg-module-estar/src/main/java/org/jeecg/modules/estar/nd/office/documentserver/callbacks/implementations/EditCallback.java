...
package org.jeecg.modules.estar.nd.office.documentserver.callbacks.implementations;

import org.jeecg.modules.estar.nd.office.documentserver.callbacks.Callback;
import org.jeecg.modules.estar.nd.office.documentserver.callbacks.Status;
import org.jeecg.modules.estar.nd.office.documentserver.managers.callback.CallbackManager;
import org.jeecg.modules.estar.nd.office.dto.Action;
import org.jeecg.modules.estar.nd.office.dto.Track;
...
public class EditCallback implements Callback {
    ...
    public int handle(Track body, String fileName) {  // handle the callback when the document is being edited
        ...
        if (action.getType().equals(org.jeecg.modules.estar.nd.office.documentserver.models.enums.Action.edit)) {  // if this value is not equal to the user ID
