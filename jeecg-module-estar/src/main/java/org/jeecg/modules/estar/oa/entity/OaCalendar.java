...
@ApiModel(value="oa_calendar对象", description="OA日历表")
public class OaCalendar implements Serializable {
	...
	/**日历类型*/
	@Excel(name = "日历类型", width = 15, dicCode = "oa_calendar_type")
	@Dict(dicCode = "oa_calendar_type")
